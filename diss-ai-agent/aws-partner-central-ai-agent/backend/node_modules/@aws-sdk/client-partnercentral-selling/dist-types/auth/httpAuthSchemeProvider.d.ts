 ...
 * @internal
 */
export interface PartnerCentralSellingHttpAuthSchemeParametersProvider extends HttpAuthSchemeParametersProvider<PartnerCentralSellingClientResolvedConfig, HandlerExecutionContext, PartnerCentralSellingHttpAuthSchemeParameters, object> {
}
/**
 * @internal
 */
export declare const defaultPartnerCentralSellingHttpAuthSchemeParametersProvider: (config: PartnerCentralSellingClientResolvedConfig, context: HandlerExecutionContext, input: object) => Promise<PartnerCentralSellingHttpAuthSchemeParameters>;
/**
 * @internal
 */
