...
export interface PartnerCentralSelling {
     ...
     */
    assignOpportunity(args: AssignOpportunityCommandInput, options?: __HttpHandlerOptions): Promise<AssignOpportunityCommandOutput>;
    assignOpportunity(args: AssignOpportunityCommandInput, cb: (err: any, data?: AssignOpportunityCommandOutput) => void): void;
    assignOpportunity(args: AssignOpportunityCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: AssignOpportunityCommandOutput) => void): void;
    /**
     ...
     */
    disassociateOpportunity(args: DisassociateOpportunityCommandInput, options?: __HttpHandlerOptions): Promise<DisassociateOpportunityCommandOutput>;
    disassociateOpportunity(args: DisassociateOpportunityCommandInput, cb: (err: any, data?: DisassociateOpportunityCommandOutput) => void): void;
    disassociateOpportunity(args: DisassociateOpportunityCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DisassociateOpportunityCommandOutput) => void): void;
    /**
     ...
     */
    getEngagementInvitation(args: GetEngagementInvitationCommandInput, options?: __HttpHandlerOptions): Promise<GetEngagementInvitationCommandOutput>;
    getEngagementInvitation(args: GetEngagementInvitationCommandInput, cb: (err: any, data?: GetEngagementInvitationCommandOutput) => void): void;
    getEngagementInvitation(args: GetEngagementInvitationCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: GetEngagementInvitationCommandOutput) => void): void;
    /**
     ...
     */
    rejectEngagementInvitation(args: RejectEngagementInvitationCommandInput, options?: __HttpHandlerOptions): Promise<RejectEngagementInvitationCommandOutput>;
    rejectEngagementInvitation(args: RejectEngagementInvitationCommandInput, cb: (err: any, data?: RejectEngagementInvitationCommandOutput) => void): void;
    rejectEngagementInvitation(args: RejectEngagementInvitationCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: RejectEngagementInvitationCommandOutput) => void): void;
    /**
     * @see {@link StartEngagementByAcceptingInvitationTaskCommand}
     */
    startEngagementByAcceptingInvitationTask(args: StartEngagementByAcceptingInvitationTaskCommandInput, options?: __HttpHandlerOptions): Promise<StartEngagementByAcceptingInvitationTaskCommandOutput>;
    startEngagementByAcceptingInvitationTask(args: StartEngagementByAcceptingInvitationTaskCommandInput, cb: (err: any, data?: StartEngagementByAcceptingInvitationTaskCommandOutput) => void): void;
    startEngagementByAcceptingInvitationTask(args: StartEngagementByAcceptingInvitationTaskCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: StartEngagementByAcceptingInvitationTaskCommandOutput) => void): void;
    /**
     ...
     */
    updateOpportunity(args: UpdateOpportunityCommandInput, options?: __HttpHandlerOptions): Promise<UpdateOpportunityCommandOutput>;
    updateOpportunity(args: UpdateOpportunityCommandInput, cb: (err: any, data?: UpdateOpportunityCommandOutput) => void): void;
    updateOpportunity(args: UpdateOpportunityCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: UpdateOpportunityCommandOutput) => void): void;
}
/**
