...
export const AccountReceiverFilterSensitiveLog = (obj) => ({
    ...obj,
    ...(obj.Alias && { Alias: SENSITIVE_STRING }),
    ...(obj.AwsAccountId && { AwsAccountId: SENSITIVE_STRING }),
});
export const AddressSummaryFilterSensitiveLog = (obj) => ({
    ...obj,
    ...(obj.City && { City: SENSITIVE_STRING }),
    ...(obj.PostalCode && { PostalCode: SENSITIVE_STRING }),
    ...(obj.StateOrRegion && { StateOrRegion: SENSITIVE_STRING }),
...
export const AccountSummaryFilterSensitiveLog = (obj) => ({
    ...obj,
    ...(obj.CompanyName && { CompanyName: SENSITIVE_STRING }),
    ...(obj.WebsiteUrl && { WebsiteUrl: SENSITIVE_STRING }),
    ...(obj.Address && { Address: AddressSummaryFilterSensitiveLog(obj.Address) }),
});
export const AssigneeContactFilterSensitiveLog = (obj) => ({
    ...obj,
...
export const AssignOpportunityRequestFilterSensitiveLog = (obj) => ({
    ...obj,
...
export const AwsOpportunityCustomerFilterSensitiveLog = (obj) => ({
    ...obj,
    ...(obj.Contacts && { Contacts: obj.Contacts.map((item) => ContactFilterSensitiveLog(item)) }),
});
export const AwsOpportunityLifeCycleFilterSensitiveLog = (obj) => ({
    ...obj,
...
export const EngagementCustomerFilterSensitiveLog = (obj) => ({
    ...obj,
    ...(obj.CompanyName && { CompanyName: SENSITIVE_STRING }),
    ...(obj.WebsiteUrl && { WebsiteUrl: SENSITIVE_STRING }),
    ...(obj.CountryCode && { CountryCode: SENSITIVE_STRING }),
...
export const OpportunityInvitationPayloadFilterSensitiveLog = (obj) => ({
    ...obj,
    ...(obj.SenderContacts && {
...
export const ReceiverFilterSensitiveLog = (obj) => {
    if (obj.Account !== undefined)
        return { Account: AccountReceiverFilterSensitiveLog(obj.Account) };
    if (obj.$unknown !== undefined)
        return { [obj.$unknown[0]]: "UNKNOWN" };
};
...
export const EngagementMemberSummaryFilterSensitiveLog = (obj) => ({
    ...obj,
    ...(obj.CompanyName && { CompanyName: SENSITIVE_STRING }),
});
export const GetEngagementInvitationResponseFilterSensitiveLog = (obj) => ({
    ...
    ...(obj.Receiver && { Receiver: ReceiverFilterSensitiveLog(obj.Receiver) }),
    ...(obj.Payload && { Payload: PayloadFilterSensitiveLog(obj.Payload) }),
    ...(obj.InvitationMessage && { InvitationMessage: SENSITIVE_STRING }),
    ...(obj.ExistingMembers && {
...
export const ListEngagementInvitationsResponseFilterSensitiveLog = (obj) => ({
    ...obj,
    ...(obj.EngagementInvitationSummaries && {
        EngagementInvitationSummaries: obj.EngagementInvitationSummaries.map((item) => EngagementInvitationSummaryFilterSensitiveLog(item)),
    }),
});
export const CustomerFilterSensitiveLog = (obj) => ({
    ...obj,
...
export const GetAwsOpportunitySummaryResponseFilterSensitiveLog = (obj) => ({
    ...obj,
...
export const CustomerSummaryFilterSensitiveLog = (obj) => ({
    ...obj,
    ...(obj.Account && { Account: AccountSummaryFilterSensitiveLog(obj.Account) }),
});
export const LifeCycleSummaryFilterSensitiveLog = (obj) => ({
    ...obj,
    ...(obj.NextSteps && { NextSteps: SENSITIVE_STRING }),
});
...
export const UpdateOpportunityRequestFilterSensitiveLog = (obj) => ({
    ...obj,
    ...(obj.Customer && { Customer: CustomerFilterSensitiveLog(obj.Customer) }),
    ...(obj.Project && { Project: ProjectFilterSensitiveLog(obj.Project) }),
    ...(obj.SoftwareRevenue && { SoftwareRevenue: SoftwareRevenueFilterSensitiveLog(obj.SoftwareRevenue) }),
